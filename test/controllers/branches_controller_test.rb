...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference("Branch.count") do
      post branches_url, params: { branch: { description: @branch.description, name: @branch.name, tree_id: @branch.tree_id } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { description: @branch.description, name: @branch.name, tree_id: @branch.tree_id } }
